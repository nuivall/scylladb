...
# Restored verbatim (imports aside) from ccm's ccmlib/utils/version.py, needed by
# not-yet-adapted dtest/unported test modules that import ComparableScyllaVersion.
