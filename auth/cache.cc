...
future<lw_shared_ptr<cache::role_record>> cache::load_role(const role_name_t& role) {
...
future<> cache::load_all() {
    ...
    co_await _qp->query_internal(format("SELECT * FROM {}.{}", db::system_keyspace::NAME, meta::roles_table::name),
