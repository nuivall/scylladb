...
{
    auto stmt = strong_consistency::make_modification<cql3::statements::insert_statement>(db, schema, audit_info(), ctx.bound_variables_size(), schema, std::move(attrs), stats);
